...
More realistic, though less well documented, examples can be found in the following files:
  ...
  * `CombineTools/bin/ChronoSpectra.cpp` ([source code](\ref CombineTools/bin/ChronoSpectra.cpp)) - see separate page [here](\ref chronospectra)
